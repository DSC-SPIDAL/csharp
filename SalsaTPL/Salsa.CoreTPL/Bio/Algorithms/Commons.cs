...
namespace Salsa.Core.Bio.Algorithms
{
    ...
    public abstract class Commons
    {
        ...
        private static readonly string userDirectory = DEFAULT_USER_DIRECTORY;

        /// <summary> Line separator</summary>
        private static readonly string fileSeparator = DEFAULT_FILE_SEPARATOR;

        /// <summary> Line separator</summary>
        private static readonly string lineSeparator = DEFAULT_LINE_SEPARATOR;
        ...
        {
            {
                ...
                {
                    Console.Error.WriteLine("Failed getting user current directory: " + e);
                }
            }

            {
                ...
                {
                    Console.Error.WriteLine("Failed getting system file separator: " + e);
                }
            }

            {
                ...
                {
                    Console.Error.WriteLine("Failed getting system line separator: " + e);
                }
            }
        }
