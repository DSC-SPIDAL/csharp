...
namespace Salsa.Core.Blas
{
    ...
    public class EigenvalueDecomposition
    {
        ...
        private OnDemandComputation<Matrix<T>> _blockDiagonalOnDemand;
        private OnDemandComputation<Matrix<T>> _eigenVectorsOnDemand;
        ...
        public EigenvalueDecomposition(Matrix<T> Arg)
        {
            double[][] A = Arg;
            _n = Arg.ColumnCount;
            _V = Matrix<T>.CreateElements(_n, _n);
            _d = new double[_n];
            _e = new double[_n];
            ...
            {
                H = Matrix<T>.CreateElements(_n, _n);
                ort = new double[_n];
        ...
        private Matrix<T> ComputeBlockDiagonalMatrix()
        {
            double[][] D = Matrix<T>.CreateElements(_n, _n);
            ...
            return new Matrix<T>(D);
        }

        private Matrix<T> ComputeEigentVectors()
        {
            return new Matrix<T>(_V);
        }
